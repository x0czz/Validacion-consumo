...
execute-dir: .. # para comenzar todos los paths desde la raíz y no tener problemas al renderizar
---
...
knitr::opts_knit$set(root.dir = "..") # para comenzar todos los paths desde la raíz y no tener problemas al renderizar
```
